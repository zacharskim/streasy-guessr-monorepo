  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-sm text-gray-700 dark:text-gray-300 space-y-2">
        <p><span className="font-semibold">Location:</span> {apartment.neighborhood}, {apartment.borough}</p>
        ...
        <p><span className="font-semibold">Photos:</span> {apartment.photo_count}</p>
